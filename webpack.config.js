...
module.exports = function build(parameter) {
	...
	return {
		"entry": parameter.test ? "./test.js" : "./focus-detail.support.js",
		...
		"output": {
			"library": parameter.test ? "test" : "focus-detail",
			"libraryTarget": "umd",
			"filename": parameter.test ? "test.deploy.js" : "focus-detail.deploy.js"
		},
